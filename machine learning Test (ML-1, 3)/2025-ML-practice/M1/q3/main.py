...
def main():
    # 데이터를 불러옵니다.
    x_train, y_train, x_val, y_val = preprocess.load_data("C://Users/302-24/Desktop/machine learning/(250320) 머신러닝 분류 실습/q3", independent_var = ['petal length', 'sepal length'], response_var = 'class_num' )
